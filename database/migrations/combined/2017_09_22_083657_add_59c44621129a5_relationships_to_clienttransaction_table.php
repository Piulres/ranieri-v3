...
class Add59c44621129a5RelationshipsToClientTransactionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('client_transactions', function(Blueprint $table) {
            if(Schema::hasColumn('client_transactions', 'project_id')) {
                $table->dropForeign('75469_59c2fecb2fda2');
                $table->dropIndex('75469_59c2fecb2fda2');
                $table->dropColumn('project_id');
            }
            if(Schema::hasColumn('client_transactions', 'transaction_type_id')) {
                $table->dropForeign('75469_59c2fecb3ec75');
                $table->dropIndex('75469_59c2fecb3ec75');
                $table->dropColumn('transaction_type_id');
            }
            if(Schema::hasColumn('client_transactions', 'income_source_id')) {
                $table->dropForeign('75469_59c2fecb4caf6');
                $table->dropIndex('75469_59c2fecb4caf6');
                $table->dropColumn('income_source_id');
            }
            if(Schema::hasColumn('client_transactions', 'currency_id')) {
                $table->dropForeign('75469_59c2fecb5a6ce');
                $table->dropIndex('75469_59c2fecb5a6ce');
