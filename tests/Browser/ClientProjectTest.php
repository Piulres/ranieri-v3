    ...
    public function testCreateClientProject()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $client_project) {
            $browser->loginAs($admin)
                ...
                ->select("produtora_id", $client_project->produtora_id)
                ...
                ->assertSeeIn("tr:last-child td[field-key='produtora']", $client_project->produtora->nome)
    ...
    public function testEditClientProject()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $client_project, $client_project2) {
            $browser->loginAs($admin)
                ...
                ->select("produtora_id", $client_project2->produtora_id)
                ...
                ->assertSeeIn("tr:last-child td[field-key='produtora']", $client_project2->produtora->nome)
    ...
    public function testShowClientProject()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $client_project) {
            $browser->loginAs($admin)
                ...
                ->assertSeeIn("td[field-key='produtora']", $client_project->produtora->nome)
