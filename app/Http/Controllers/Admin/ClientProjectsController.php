...
class ClientProjectsController extends Controller
{
    ...
    public function create()
    {
        ...
        $produtoras = \App\Produtora::get()->pluck('nome', 'id')->prepend(trans('global.app_please_select'), '');
        $project_statuses = \App\ClientProjectStatus::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');

        return view('admin.client_projects.create', compact('clients', 'produtoras', 'project_statuses'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.client_projects.edit', compact('client_project', 'clients', 'produtoras', 'project_statuses'));
    }
