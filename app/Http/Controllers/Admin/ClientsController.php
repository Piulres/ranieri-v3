...
class ClientsController extends Controller
{
    ...
    public function create()
    {
        ...
        $client_statuses = \App\ClientStatus::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $client_statuses = \App\ClientStatus::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');$client_projects = \App\ClientProject::where('client_id', $id)->get();
