...
{
    protected $fillable = ['title', 'description', 'date', 'budget', 'client_id', 'produtora_id', 'project_status_id'];
     ...
     * @param $input
     */
    public function setProdutoraIdAttribute($input)
    {
        $this->attributes['produtora_id'] = $input ? $input : null;
    }
    ...
    {
        return $this->belongsTo(Produtora::class, 'produtora_id')->withTrashed();
    }
