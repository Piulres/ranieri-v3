...
<li role="presentation" class="active"><a href="#clientnotes" aria-controls="clientnotes" role="tab" data-toggle="tab">Notas</a></li>
<li role="presentation" class=""><a href="#clientdocuments" aria-controls="clientdocuments" role="tab" data-toggle="tab">Documentos</a></li>
<li role="presentation" class=""><a href="#clienttransactions" aria-controls="clienttransactions" role="tab" data-toggle="tab">Transações</a></li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    
<div role="tabpanel" class="tab-pane active" id="clientnotes">
                ...
                <tr data-entry-id="{{ $client_note->id }}">
                    <td field-key='project'>{{ $client_note->project->title or '' }}</td>
                                <td field-key='text'>{!! $client_note->text !!}</td>
                                                                <td>
                                    @can('client_note_view')
                                    <a href="{{ route('admin.client_notes.show',[$client_note->id]) }}" class="btn btn-xs btn-primary">@lang('global.app_view')</a>
                                    @endcan
                                    @can('client_note_edit')
                                    <a href="{{ route('admin.client_notes.edit',[$client_note->id]) }}" class="btn btn-xs btn-info">@lang('global.app_edit')</a>
                                    @endcan
                                    @can('client_note_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
                                        'method' => 'DELETE',
                                        'onsubmit' => "return confirm('".trans("global.app_are_you_sure")."');",
                                        'route' => ['admin.client_notes.destroy', $client_note->id])) !!}
...
<div role="tabpanel" class="tab-pane " id="clientdocuments">
...
<div role="tabpanel" class="tab-pane " id="clienttransactions">
