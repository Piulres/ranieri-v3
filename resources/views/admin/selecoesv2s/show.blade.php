            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>@lang('global.selecoesv2.fields.descricao')</th>
                            <td field-key='descricao'>{{ $selecoesv2->descricao }}</td>
                        </tr>
                        <tr>
...
<li role="presentation" class="active"><a href="#selecaoelenco" aria-controls="selecaoelenco" role="tab" data-toggle="tab">Selecao Elenco</a></li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    
<div role="tabpanel" class="tab-pane active" id="selecaoelenco">
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.selecoesv2s.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
    </div>
@stop
