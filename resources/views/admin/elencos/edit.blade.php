...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PUT', 'route' => ['admin.elencos.update', $user->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($user->fotoprincipal)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$user->fotoprincipal) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$user->fotoprincipal) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @if ($user->curriculum)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $user->curriculum) }}" target="_blank">Download file</a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('exclusividade', 1, old('exclusividade'), []) !!}
                    <p class="help-block"></p>
